 ...
 */
class AnimatedTexture(val delay: Float, vararg tex: TextureRegion, val mode: PlayMode = PlayMode.LOOP) :
    Animation<TextureRegion>(delay, *tex) {
    constructor(delay: Float, t: Array<Array<TextureRegion>>, default: IntRange, mode: PlayMode = PlayMode.LOOP) : this(
        delay,
