 ...
 */
internal class MappedController(
    ...
    var DPAD_RIGHT: Int =
        -1
    var L_STICK_PUSH: Int =
        10
    var R_STICK_PUSH: Int =
        11
    ...
    fun setToMacDefault() {
        ...
        L_STICK_VERTICAL_AXIS =
                1

        L_STICK_HORIZONTAL_AXIS =
                0

        R_STICK_VERTICAL_AXIS =
                3

        R_STICK_HORIZONTAL_AXIS =
                2
    }
    ...
    fun setToX360() {
        ...
        DPAD_RIGHT =
                -1
        L_STICK_PUSH =
                8 // was 10, changed for wii u pad
        R_STICK_PUSH =
                9 // was 11
        ...
        L_TRIGGER_AXIS =
                4
        R_TRIGGER_AXIS =
                5 // doesnt work on 360 pad, both are same axis
        crippledTrigger =
                true

        R_TRIGGER =
                7 // doesnt work on 360 pad
        L_TRIGGER =
                6 // doesnt work on 360 pad
    ...
    init {
        if (isOSX) {
            ...
            if (controller.name.contains(
                    "Sony"
                )
            ) {
                setToLinuxDefault()
            } else if (controller.name.contains(
                    "X-Box"
                )
            ) {
                setToLinuxXbox()
    ...
    var listener: ControllerAdapter? =
        null
}