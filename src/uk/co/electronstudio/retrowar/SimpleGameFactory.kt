...
class SimpleGameFactory(name: String, private val gameClazz: Class<out Game>, path: String,
                        override val image: Texture = Resources.MISSING_TEXTURE,
                        override val description: String = name) : AbstractGameFactory(name = name, pathPrefix = path) {
