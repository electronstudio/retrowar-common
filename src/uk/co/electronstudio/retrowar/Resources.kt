    ...
    companion object {
        ...
        var TEXT =
            I18NBundle.createBundle(
                load(
                    "uk/co/electronstudio/retrowar/i18n/RetroWar",
                    "i18n/RetroWar"
                )
            )
        @JvmStatic
        val MISSING_TEXTURE =
            Texture(
                Gdx.files.classpath(
                    "uk/co/electronstudio/retrowar/badlogic.jpg"
                )
            )
        @JvmStatic
        val MISSING_TEXTUREREGION =
            TextureRegion(
                MISSING_TEXTURE
            )

        private var fallbackFont =
            "uk/co/electronstudio/retrowar/english.fnt"
        @JvmStatic
        val FONT =
            BitmapFont(
                load(
        ...
        val BLING =
            Gdx.audio.newSound(
                load(
                    "uk/co/electronstudio/retrowar/bling.wav",
                    "bling.wav"
                )
            )!!
