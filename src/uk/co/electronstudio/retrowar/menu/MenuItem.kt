...
class MultiPrefMenuItem(
    text: String,
    val mPref: Prefs.MultiChoicePref,
    val action: () -> Unit = {}
) : MenuItem(
    text
) {
...
class NumPrefMenuItem(
    text: String,
    val numPref: Prefs.NumPref
) : MenuItem(
    text
) {
    override fun displayText() =
...
class StringPrefMenuItem(
    text: String,
    val stringPref: Prefs.StringPref
) : MenuItem(
    text
) {
    override fun displayText() =
        stringPref.displayText()
