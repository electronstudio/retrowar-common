...
open class SimpleTitleScreen(
    ...
    init {
        ...
        videoOptions.addAll(
            listOf(
                MultiPrefMenuItem(
                    "Graphics ",
                    Prefs.MultiChoicePref.GRAPHICS
                ),
                BinPrefMenuItem(
                    "Scaling ",
                    BinPref.STRETCH
        ...
        soundOptions.addAll(
            listOf(
                ...
                NumPrefMenuItem(
                    "Music Volume ",
                    numPref = Prefs.NumPref.MUSIC_VOLUME
                ),
                NumPrefMenuItem(
                    "FX Volume ",
                    numPref = Prefs.NumPref.FX_VOLUME
                ),
                BackMenuItem(
                    "BACK"
                )
    ...
    private fun renderToFBO(
        ...
        val text =
            header + controller.menus.peek().getText(
                flash
            )
