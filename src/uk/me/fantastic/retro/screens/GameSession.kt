...
import uk.me.fantastic.retro.network.ClientGameSession
...
//    }
    ...
    fun createNetworkPlayerOnServer(name: String): Int {
        ...
        val player = Player(input = NetworkInput(), name = name, color = Color.valueOf(
...
//            }
    ...
    override fun hide() {
        ...
        app.mappedControllers
                ...
                .forEach { it.controller.removeListener(it.listener) }
    }
